                    ...
                    <>
                        {(!invoice || !invoice.paid) && (
                            <div className="bottom_spaced">
                                ...
                                <h2>JOINING</h2>
                                <p>
                                    To join {name} you need "credits". Credits
                                    are app-internal tokens which you spend as a
                                    "gas" while using the app. You can mint
                                    credits yourself or you can use an invite
                                    pre-charged with credits created by another{" "}
                                    {name} user. Ask around on socials for an
                                    invite or keep reading to get on board
                                    faster.
                                </p>
                                <p>
                                    To mint credits, you need to transfer a
                                    small amount of Bitcoin or ICP to an account
                                    controlled by the {name} canister. You get{" "}
