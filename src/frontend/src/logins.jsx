...
export const LoginMasks = ({ confirmationRequired }) => {
    ...
    return (
        <div
            className={`vertically_spaced text_centered stands_out ${
        ...
        >
            {authMethods.map((method, i) => (
                <button
                    key={i}
                    className={
                        `large_text active left_half_spaced right_half_spaced ` +
...
export const SeedPhraseForm = ({ callback, confirmationRequired }) => {
    ...
    return (
        <div className="row_container spaced vertically_spaced">
            <input
                ref={field}
            ...
            {confirmationRequired && (
                <input
                    ...
                    className="max_width_col left_half_spaced right_half_spaced"
                    type="password"
