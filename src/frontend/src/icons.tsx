...
export const Eye = ({ classNameArg }: { classNameArg?: string }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
...
export const EyeSlash = ({ classNameArg }: { classNameArg?: string }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        className={`vertically_aligned ${classNameArg}`}
        width="16"
...
export const Pin = ({ classNameArg }: { classNameArg?: string }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        className={`vertically_aligned ${classNameArg}`}
        width="16"
...
export const Roadmap = ({ classNameArg }: { classNameArg?: string }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        className={`vertically_aligned ${classNameArg}`}
        width="16"
...
export const Add = ({ classNameArg }: { classNameArg?: string }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        className={`vertically_aligned ${classNameArg}`}
        width="17"
